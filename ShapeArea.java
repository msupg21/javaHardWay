...
public class ShapeArea {
	public static void main( String[] args ) {
		...
		do {
			...
			if ( choice == 1 ) {
				...
				double area1 = keyboard.nextDouble();
				System.out.println("\tThe area of your square is " + computeSquareSquare(area1));
	...
	public static double computeSquareSquare(double area1) {
		return (area1 * area1);
	}
